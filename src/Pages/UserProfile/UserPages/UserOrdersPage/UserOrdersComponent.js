...
const UserOrdersComponent = ({orderDate, orderTime, orderPrice, productName, orderType, orderCode, productImg}) => {
  return (
    <>
      <OrderComponentWrapper>
        <OrderComponentImgWrapper>
        ...
        <OrderComponentContentWrapper>
            <OrderComponentsContentColumn1>
                <OrderComponentTopicParaWrapper style={{marginBottom : "2rem"}}>
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text11 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
                ...
                <OrderComponentTopicParaWrapper style={{marginBottom : "2rem"}}>
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text12 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
                ...
                <OrderComponentTopicParaWrapper>
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text13 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
            </OrderComponentsContentColumn1>
            ...
            <OrderComponentTopicParaWrapper style={{marginBottom : "2rem"}} >
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text8 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
                ...
                <OrderComponentTopicParaWrapper style={{marginBottom : "2rem"}}>
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text9 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
                ...
                <OrderComponentTopicParaWrapper>
                    ...
                    <OrderComponentTopicWrapper>
                        <OrderComponentTopic> : {UserProfileData1.text10 } </OrderComponentTopic>
                    </OrderComponentTopicWrapper>
                </OrderComponentTopicParaWrapper>
            </OrderComponentsContentColumn2>
        </OrderComponentContentWrapper>
